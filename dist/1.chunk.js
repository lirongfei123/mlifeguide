...
var routes = [
    { path: '', children: [
            ...
            { path: 'child-barrel', loadChildren: function() { return __webpack_require__.e/* import() */(5).then(__webpack_require__.bind(null, 235))  .then( function(module) { return module['ChildBarrelModule']; } ); } }
        ] },
];
